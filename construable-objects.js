...
console.log(
    ...
    Object.getPrototypeOf(constructed) === constructed.constructor.prototype
);

console.log(
    "is 'constructor' just a reference to my function?",
    constructed.constructor === Construable
);
...
console.log(
    ...
    anotherConstructed.constructor.prototype === Object.getPrototypeOf(anotherConstructed)
);

console.log(
    "'instanceof' operator lets you perform recursive prototype check",
